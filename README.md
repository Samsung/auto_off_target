...
* In order to run AoT you need to have CAS databases (nfsdb.json, db.json) available for the target system. The creation of the database is beyond the scope of AoT, in a nutshell CAS happens during the build process. Please check the CAS (https://github.com/Samsung/CAS) project for more details.
